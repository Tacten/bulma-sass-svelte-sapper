...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file, 31, 6, 1006);
			add_location(li, file, 31, 2, 1002);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			document.title = "Blog";
			add_location(h1, file, 23, 0, 733);
			attr_dev(ul, "class", "svelte-kccaix");
			add_location(ul, file, 25, 0, 756);
		},
		m: function mount(target, anchor) {
